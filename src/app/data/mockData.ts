...
export const mockReports: Report[] = [
  {
    ...
    location: {
      lat: -1.2833,
      lng: 36.8167,
      address: "Moi Avenue near Tom Mboya Street, Nairobi CBD"
    },
  ...
  },
  {
    ...
    location: {
      lat: -1.2921,
      lng: 36.8219,
      address: "Luthuli Avenue, Westlands, Nairobi"
    },
    reportedBy: "jane.smith@email.com",
    dateReported: "2024-01-12T14:20:00Z",
  ...
  },
  {
    ...
    location: {
      lat: -1.2864,
      lng: 36.8172,
      address: "Koinange Street, River Road, Nairobi"
    },
    reportedBy: "mike.johnson@email.com",
    dateReported: "2024-01-14T16:45:00Z",
    dateUpdated: "2024-01-14T16:45:00Z",
    severity: 9,
    frequency: 1,
    riskFactor: 8
  },
  {
    ...
    dateReported: "2024-01-13T11:10:00Z",
    dateUpdated: "2024-01-13T11:10:00Z",
    severity: 7,
    frequency: 3,
    riskFactor: 8
  },
  {
    ...
    location: {
      lat: -1.2667,
      lng: 36.8167,
      address: "Parklands Avenue, Parklands, Nairobi"
    },
    reportedBy: "david.brown@email.com",
    dateReported: "2024-01-10T08:30:00Z",
  ...
  },
  {
    ...
    location: {
      lat: -1.2921,
      lng: 36.8219,
      address: "Westlands Roundabout, Nairobi"
    },
    reportedBy: "lisa.davis@email.com",
    dateReported: "2024-01-16T12:00:00Z",
    dateUpdated: "2024-01-16T13:30:00Z",
    severity: 8,
    frequency: 4,
    riskFactor: 9
  },
  {
    ...
    location: {
      lat: -1.2833,
      lng: 36.8167,
      address: "Luthuli Avenue near Sarit Centre, Westlands"
    },
    reportedBy: "robert.miller@email.com",
    dateReported: "2024-01-15T09:15:00Z",
  ...
  },
  {
    ...
    location: {
      lat: -1.3000,
      lng: 36.8000,
      address: "Residential area, Kilimani, Nairobi"
    },
    reportedBy: "anna.garcia@email.com",
...
export const categoryDistribution = [
  { id: "cat-pothole", name: "Pothole", value: 2 },
  { id: "cat-streetlight", name: "Street Light", value: 1 },
  { id: "cat-waterleak", name: "Water Leak", value: 1 },
  { id: "cat-drainage", name: "Drainage", value: 1 },
  { id: "cat-sidewalk", name: "Sidewalk", value: 1 },
  { id: "cat-trafficsignal", name: "Traffic Signal", value: 1 },
  { id: "cat-wastemanagement", name: "Waste Management", value: 1 }
];

export const monthlyTrends = [
  { id: "month-sep", month: "Sep", reports: 0 },
  { id: "month-oct", month: "Oct", reports: 0 },
  { id: "month-nov", month: "Nov", reports: 0 },
  { id: "month-dec", month: "Dec", reports: 0 },
  { id: "month-jan", month: "Jan", reports: 8 },
  { id: "month-feb", month: "Feb", reports: 0 }
];